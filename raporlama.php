 ...
 <div class="card card-primary">
              ...
              <form action="islemtxt.php" method="POST" role="form">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label >Vize</label>
                    <input name="vize" type="text" class="form-control" value="<?php $vize?>" placeholder="vize">
                  </div>


                  <div class="form-group">
                    <label >Final</label>
                    <input name="final" type="text" class="form-control" value="<?php $final?>" placeholder="final">
                  </div>


                  <div class="form-group">
                    <label >Ortalama</label>
                    <input name="basari" type="float" class="form-control" value="<?php $basari?>" placeholder="basari">
                  </div>

                  <div class="form-group">
                    <label >Harf Notu</label>
                    <input name="harf" type="text" class="form-control" value="<?php $harf?>"  placeholder="Harf Notu">
                  </div>
